...
nl2sql = NL2SQLTool(db_uri=os.environ['DB_URL'], tables=["business","pins"])
...
class Alertli2:
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            ...
            tasks=[self.alertli_search()],  # Automatically created by the @task decorator
